...
class MemoriesControllerTest < ActionController::TestCase
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post :create, :memory => { :ddr => @memory.ddr, :frecuencia => @memory.frecuencia, :marca => @memory.marca, :tamaño => @memory.tamaño }
    end
  ...
  test "should update memory" do
    put :update, :id => @memory, :memory => { :ddr => @memory.ddr, :frecuencia => @memory.frecuencia, :marca => @memory.marca, :tamaño => @memory.tamaño }
    assert_redirected_to memory_path(assigns(:memory))
  end
